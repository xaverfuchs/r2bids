...
#'
#'
#' @format A data frame with 32455 rows and 30 variables:
#' \describe{
...
#' }
#' @source Data collected in a behavioral neuroscience experiment at Tobias Heed's Reach and Touch Lab.
"B006Data"
